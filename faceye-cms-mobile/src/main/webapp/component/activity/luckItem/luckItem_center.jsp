...
<div class="page-head">
	<h2>
		...
		<a class="btn btn-primary" href="<c:url value="/activity/luckItem/input"/>"> <fmt:message
				key="activity.luckItem.add"></fmt:message>
		</a>
	</h2>
</div>
<div class="cl-mcont">
	...
	<div class="block-flat">
		<div class="content">
			<form action="<c:url value="/activity/luckItem/home"/>" method="post" role="form"
						...
						<c:forEach items="${page.content}" var="luckItem">
							<tr>
							   <td><input type="checkbox" name="check-single" value="${luckItem.id}"></td>
								...
								<td><a href="<c:url value="/activity/luckItem/edit/${luckItem.id}"/>">
										<fmt:message key="global.edit"></fmt:message>
								</a></td>
								<td><a href="<c:url value="/activity/luckItem/remove/${luckItem.id}"/>">
