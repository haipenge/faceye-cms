...
<div class="container" id="g-container">
	...
	<form class="form-horizontal" action="/weixinApp/onPersonalSignSubmit" id="form-container">
		<div class="form-group">
			<label for="name" class="col-sm-2 col-xs-2 control-label">他是</label>
				...
				$('#btn-submit').click(
						function() {
							...
							if (name && name.length > 4) {
								...
								var img = '<img src="/weixinApp/onPersonalSignSubmit?name=' + name
