...
<div class="page-head">
	<h2>
		...
		<a class="btn btn-primary" href="<c:url value="/activity/customer/input"/>"> <fmt:message
				key="activity.customer.add"></fmt:message>
		</a>
	</h2>
</div>
<div class="cl-mcont">
	...
	<div class="block-flat">
		<div class="content">
			<form action="<c:url value="/activity/customer/home"/>" method="post" role="form"
						...
						<c:forEach items="${page.content}" var="customer">
							<tr>
							   <td><input type="checkbox" name="check-single" value="${customer.id}"></td>
								...
								<td><a href="<c:url value="/activity/customer/edit/${customer.id}"/>">
										<fmt:message key="global.edit"></fmt:message>
								</a></td>
								<td><a href="<c:url value="/activity/customer/remove/${customer.id}"/>">
