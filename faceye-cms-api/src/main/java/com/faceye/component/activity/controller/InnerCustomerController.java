...
public class InnerCustomerController extends BaseController<InnerCustomer, Long, InnerCustomerService> {
	...
	@RequestMapping("/home")
	@ResponseBody
	public Page<InnerCustomer> home(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public InnerCustomer detail(@PathVariable Long id,Model model){
		if(id!=null){
			InnerCustomer innerCustomer=this.service.get(id);
		}
